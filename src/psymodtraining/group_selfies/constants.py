...
INVERT_DIR = defaultdict(lambda: None, {"\\": "/", "/": "\\"})
BOND_DIR = defaultdict(
    lambda: BondDir.NONE, {"/": BondDir.ENDUPRIGHT, "\\": BondDir.ENDDOWNRIGHT}
)
BOND_DIR_REV = defaultdict(
    lambda: "", {BondDir.ENDUPRIGHT: "/", BondDir.ENDDOWNRIGHT: "\\"}
)
